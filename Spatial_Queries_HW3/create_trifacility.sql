...
create table cse532.TRIFacility(FACILITY_NAME varchar(150),  ST char(10), CHEMICAL varchar(150), CARCINOGEN char(10), LATITUDE double, LONGITUDE double);

import from "D:\ZZZ_Coursework\SEM2\DBMS_HW\HW3\2021_us.csv" of del
...
update cse532.TRIFacility set geolocation = db2gse.st_point(LONGITUDE, LATITUDE, 1);
